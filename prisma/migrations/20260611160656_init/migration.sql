-- CreateEnum
CREATE TYPE "MoneyAccountType" AS ENUM ('BANK', 'CREDIT_CARD', 'UPI_WALLET', 'CASH', 'LOAN');
...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('UPI', 'AUTO_DEBIT', 'NEFT', 'CARD', 'CASH');

-- CreateEnum
CREATE TYPE "RecurringFrequency" AS ENUM ('WEEKLY', 'MONTHLY', 'YEARLY');

-- CreateEnum
CREATE TYPE "RecurringKind" AS ENUM ('EXPENSE', 'INVESTMENT');
...
-- CreateIndex
CREATE INDEX "Transaction_userId_moneyAccountId_idx" ON "Transaction"("userId", "moneyAccountId");
...
-- AddForeignKey
ALTER TABLE "RecurringRule" ADD CONSTRAINT "RecurringRule_moneyAccountId_fkey" FOREIGN KEY ("moneyAccountId") REFERENCES "MoneyAccount"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
